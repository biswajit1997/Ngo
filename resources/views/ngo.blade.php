            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="text-left">
                            <img src="{{ asset('storage/'.$response->org_logo)}}" alt="image" width="100px" height="50px">
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{ asset('storage/'.$response->org_ic_pdf)}}" target="_blank" class="btn btn-warning btn-sm mr-3"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill mr-2" viewBox="0 0 16 16">
                                                <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                                <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z" />
                                            </svg>View</a>
                                        <a href="{{ asset('storage/'.$response->org_ic_pdf)}}" class="btn btn-primary btn-sm" download="Organization Incorparate Certificate"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle-fill mr-2" viewBox="0 0 16 16">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ asset('storage/'.$response->mip_pdf)}}" target="_blank" class="btn btn-warning btn-sm mr-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill mr-2" viewBox="0 0 16 16">
                                                <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                                <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z" />
                                            </svg>View</a>
                                        <a href="{{ asset('storage/'.$response->mip_pdf)}}" class="btn btn-primary btn-sm" download="Id proof">
